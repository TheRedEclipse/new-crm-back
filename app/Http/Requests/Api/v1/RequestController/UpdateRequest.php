...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'rooms.*.works.*.double_current_id' => 'required|integer|exists:request_work_replaces,id',
            'rooms.*.works.*.double_replace_id' => 'required|integer|exists:request_work_replaces,id',
